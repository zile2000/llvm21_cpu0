...
void Cpu0DAGToDAGISelLegacy::getAnalysisUsage(AnalysisUsage &AU) const {
...
bool Cpu0DAGToDAGISel::runOnMachineFunction(MachineFunction &MF) {
  LLVM_DEBUG(errs() << "call Cpu0DAGToDAGISel "; errs() << "\n");
  bool Ret = SelectionDAGISel::runOnMachineFunction(MF);
  LLVM_DEBUG(errs() << "call Cpu0DAGToDAGISel ret " << Ret; errs() << "\n");
  return Ret;
}
...
//@SelectAddr }
  LLVM_DEBUG(errs() << "call SelectAddr  " ; errs() << "\n");
...
//@Select }
  unsigned Opcode = Node->getOpcode();
    ...
    LLVM_DEBUG(errs() << "call Call Select  " << Opcode ; errs() << "\n");
