...
#include "Cpu0GenAsmMatcher.inc"
  ...
  MCRegister tryParseRegister(StringRef Mnemonic);
...
MCRegister Cpu0AsmParser::getReg(int RC,int RegNo) {
...
MCRegister Cpu0AsmParser::tryParseRegister(StringRef Mnemonic) {
...
bool Cpu0AsmParser::parseRegister(MCRegister &Reg, SMLoc &StartLoc,
                                  SMLoc &EndLoc) {
...
ParseStatus Cpu0AsmParser::tryParseRegister(MCRegister &Reg,
                                                     SMLoc &StartLoc,
                                                     SMLoc &EndLoc) {
  StartLoc = Parser.getTok().getLoc();
  Reg = tryParseRegister("");
...
// eg, 12($sp) or 12(la)
ParseStatus Cpu0AsmParser::parseMemOperand(
               OperandVector &Operands) {
